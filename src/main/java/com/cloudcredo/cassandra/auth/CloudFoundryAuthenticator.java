 ...
 */
public class CloudFoundryAuthenticator implements IAuthenticator {
     ...
     */
    public CloudFoundryAuthenticator() {
    ...
    public AuthenticatedUser defaultUser() {
        return null; //Needs to be null as it is defined in the IAuthority contract
    }
